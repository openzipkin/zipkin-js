// Customized version of code generated by Thrift Compiler (0.9.3)
//
// This inlines some constants so that the thrift dep can be lazy.
//
var thrift = require.call(null, 'thrift');
...
Endpoint.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    var ftype = ret.ftype;
    var fid = ret.fid;
    if (ftype == 0 /* Thrift.Type.STOP */) {
      break;
    }
    switch (fid)
    {
      case 1:
      if (ftype == 8 /* Thrift.Type.I32 */) {
      ...
      break;
      case 3:
      if (ftype == 11 /* Thrift.Type.STRING */) {
...
Endpoint.prototype.write = function(output) {
  ...
  if (this.ipv4 !== null && this.ipv4 !== undefined) {
    output.writeFieldBegin('ipv4', 8 /* Thrift.Type.I32 */, 1);
    output.writeI32(this.ipv4);
    output.writeFieldEnd();
  }
  if (this.port !== null && this.port !== undefined) {
    output.writeFieldBegin('port', 6 /* Thrift.Type.I16 */, 2);
    output.writeI16(this.port);
    output.writeFieldEnd();
  }
  if (this.service_name !== null && this.service_name !== undefined) {
    output.writeFieldBegin('service_name', 11 /* Thrift.Type.STRING */, 3);
    output.writeString(this.service_name);
    output.writeFieldEnd();
  }
  if (this.ipv6 !== null && this.ipv6 !== undefined) {
    output.writeFieldBegin('ipv6', 11 /* Thrift.Type.STRING */, 4);
...
Annotation.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      break;
      case 3:
      if (ftype == 12 /* Thrift.Type.STRUCT */) {
...
Annotation.prototype.write = function(output) {
  ...
  if (this.timestamp !== null && this.timestamp !== undefined) {
    output.writeFieldBegin('timestamp', 10 /* Thrift.Type.I64 */, 1);
    output.writeI64(this.timestamp);
    output.writeFieldEnd();
  }
  if (this.value !== null && this.value !== undefined) {
    output.writeFieldBegin('value', 11 /* Thrift.Type.STRING */, 2);
    output.writeString(this.value);
    output.writeFieldEnd();
  }
  if (this.host !== null && this.host !== undefined) {
    output.writeFieldBegin('host', 12 /* Thrift.Type.STRUCT */, 3);
...
BinaryAnnotation.prototype.write = function(output) {
  ...
  if (this.key !== null && this.key !== undefined) {
    output.writeFieldBegin('key', 11 /* Thrift.Type.STRING */, 1);
  ...
  if (this.annotation_type !== null && this.annotation_type !== undefined) {
    output.writeFieldBegin('annotation_type', 8 /* Thrift.Type.I32 */, 3);
    output.writeI32(this.annotation_type);
    output.writeFieldEnd();
  }
  if (this.host !== null && this.host !== undefined) {
    output.writeFieldBegin('host', 12 /* Thrift.Type.STRUCT */, 4);
    this.host.write(output);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
...
Span.prototype.write = function(output) {
  ...
  if (this.trace_id !== null && this.trace_id !== undefined) {
    output.writeFieldBegin('trace_id', 10 /* Thrift.Type.I64 */, 1);
    output.writeI64(this.trace_id);
    output.writeFieldEnd();
  }
  if (this.name !== null && this.name !== undefined) {
    output.writeFieldBegin('name', 11 /* Thrift.Type.STRING */, 3);
    output.writeString(this.name);
    output.writeFieldEnd();
  }
  if (this.id !== null && this.id !== undefined) {
    output.writeFieldBegin('id', 10 /* Thrift.Type.I64 */, 4);
    output.writeI64(this.id);
    output.writeFieldEnd();
  }
  if (this.parent_id !== null && this.parent_id !== undefined) {
    output.writeFieldBegin('parent_id', 10 /* Thrift.Type.I64 */, 5);
    output.writeI64(this.parent_id);
    output.writeFieldEnd();
  }
  if (this.annotations !== null && this.annotations !== undefined) {
    output.writeFieldBegin('annotations', 15 /* Thrift.Type.LIST */, 6);
    output.writeListBegin(12 /* Thrift.Type.STRUCT */, this.annotations.length);
  ...
  if (this.binary_annotations !== null && this.binary_annotations !== undefined) {
    output.writeFieldBegin('binary_annotations', 15 /* Thrift.Type.LIST */, 8);
    output.writeListBegin(12 /* Thrift.Type.STRUCT */, this.binary_annotations.length);
  ...
  if (this.debug !== null && this.debug !== undefined) {
    output.writeFieldBegin('debug', 2 /* Thrift.Type.BOOL */, 9);
    output.writeBool(this.debug);
    output.writeFieldEnd();
  }
  if (this.timestamp !== null && this.timestamp !== undefined) {
    output.writeFieldBegin('timestamp', 10 /* Thrift.Type.I64 */, 10);
    output.writeI64(this.timestamp);
    output.writeFieldEnd();
  }
  if (this.duration !== null && this.duration !== undefined) {
    output.writeFieldBegin('duration', 10 /* Thrift.Type.I64 */, 11);
    output.writeI64(this.duration);
    output.writeFieldEnd();
  }
  if (this.trace_id_high !== null && this.trace_id_high !== undefined) {
    output.writeFieldBegin('trace_id_high', 10 /* Thrift.Type.I64 */, 12);
